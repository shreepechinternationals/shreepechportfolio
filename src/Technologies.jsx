...
function Technologies() {
  ...
  const eCommerce = [
    ...
    {
      name: "E-commerce",
      image: "/images/technology-img/ecommerce/ecommerce.png",
    },
  ];
  ...
  const MobileTechnologies = [
    ...
    {
      name: "React Native",
      image: "/images/technology-img/mobile/reactnative.png",
    },
  ...
  const designTools = [
    { name: "Figma", image: "/images/technology-img/design/figma.png" },
    {
      ...
      image: "/images/technology-img/design/photoshop.png",
    },
    {
      name: "Adobe Illustrator",
      image: "/images/technology-img/design/illustrator.png",
    },
  ...
  const cloud = [
    { name: "AWS", image: "/images/technology-img/cloud/aws.png" },
    {
      ...
      image: "/images/technology-img/cloud/azure.png",
    },
    { name: "Docker", image: "/images/technology-img/cloud/docker.png" },
    {
      name: "Google Cloud",
      image: "/images/technology-img/cloud/googlecloud.png",
    },
          ...
          <div className="row mb-4 justify-content-center">
            <div className="col-auto">
              <ul className="nav nav-tabs justify-content-center">
                <li
                  className={`nav-item ${toggle === 1 ? "active" : ""}`}
                  onClick={() => updateToggle(1)}
                >
                  Web
                </li>
                <li
                  className={`nav-item ${toggle === 2 ? "active" : ""}`}
                  onClick={() => updateToggle(2)}
                >
                  eCommerce
                </li>
                <li
                  className={`nav-item ${toggle === 3 ? "active" : ""}`}
                  onClick={() => updateToggle(3)}
                >
                  Mobile
                </li>
                <li
                  className={`nav-item ${toggle === 4 ? "active" : ""}`}
                  onClick={() => updateToggle(4)}
                >
                  Design Tools
                </li>
                <li
                  className={`nav-item ${toggle === 5 ? "active" : ""}`}
                  onClick={() => updateToggle(5)}
                >
                  Cloud
                </li>
                <li
                  className={`nav-item ${toggle === 6 ? "active" : ""}`}
